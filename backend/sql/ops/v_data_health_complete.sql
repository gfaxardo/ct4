...
SELECT * FROM (VALUES
    ...
    ('module_ct_scout_drivers', 'public', 'module_ct_scout_drivers', 'ct_ingest',
     'COALESCE(date, registration_date, created_at::date)',
     'COALESCE(created_at, updated_at)::timestamptz'),
...
source_raw_module_ct_cabinet_payments AS (
    ...
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'raw' AND table_name = 'module_ct_cabinet_payments')
        AND (pay_date IS NOT NULL OR payment_date IS NOT NULL OR date IS NOT NULL OR created_at IS NOT NULL)
),
...
source_module_ct_cabinet_migrations AS (
    ...
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_cabinet_migrations')
        AND (migration_date IS NOT NULL OR created_at IS NOT NULL)
),
source_module_ct_scout_drivers AS (
    SELECT 
        'module_ct_scout_drivers' AS source_name,
        MAX(COALESCE(date, registration_date, created_at::date)) AS max_business_date,
        CURRENT_DATE - MAX(COALESCE(date, registration_date, created_at::date)) AS business_days_lag,
        MAX(COALESCE(created_at, updated_at))::timestamptz AS max_ingestion_ts,
        NOW() - MAX(COALESCE(created_at, updated_at))::timestamptz AS ingestion_lag_interval,
        COUNT(*) FILTER (
            WHERE COALESCE(date, registration_date, created_at::date) = CURRENT_DATE - INTERVAL '1 day'
        ) AS rows_business_yesterday,
        COUNT(*) FILTER (
            WHERE COALESCE(date, registration_date, created_at::date) = CURRENT_DATE
        ) AS rows_business_today,
        COUNT(*) FILTER (
            WHERE COALESCE(created_at, updated_at)::date = CURRENT_DATE - INTERVAL '1 day'
        ) AS rows_ingested_yesterday,
    ...
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_scout_drivers')
        AND (date IS NOT NULL OR registration_date IS NOT NULL OR created_at IS NOT NULL)
),
source_module_ct_cabinet_payments AS (
    ...
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_cabinet_payments')
        AND (pay_date IS NOT NULL OR payment_date IS NOT NULL OR date IS NOT NULL OR created_at IS NOT NULL)
),
source_drivers AS (
    SELECT 
...
source_module_ct_scouts_list AS (
    ...
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_scouts_list')
...
UNION ALL
SELECT * FROM source_raw_module_ct_cabinet_payments WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'raw' AND table_name = 'module_ct_cabinet_payments')
UNION ALL
SELECT * FROM source_module_ct_cabinet_leads
UNION ALL
SELECT * FROM source_module_ct_scouting_daily
UNION ALL
SELECT * FROM source_module_ct_cabinet_migrations WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_cabinet_migrations')
UNION ALL
SELECT * FROM source_module_ct_scout_drivers WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_scout_drivers')
UNION ALL
SELECT * FROM source_module_ct_cabinet_payments WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_cabinet_payments')
UNION ALL
SELECT * FROM source_drivers
UNION ALL
SELECT * FROM source_module_ct_scouts_list WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_scouts_list');
...
source_raw_module_ct_cabinet_payments_daily AS (
    ...
    FROM raw.module_ct_cabinet_payments
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'raw' AND table_name = 'module_ct_cabinet_payments')
        AND COALESCE(pay_date, payment_date, date, created_at::date) >= CURRENT_DATE - INTERVAL '90 days'
    ...
    FROM raw.module_ct_cabinet_payments
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'raw' AND table_name = 'module_ct_cabinet_payments')
        AND COALESCE(snapshot_at, loaded_at, ingested_at, created_at, updated_at)::date >= CURRENT_DATE - INTERVAL '90 days'
...
source_module_ct_cabinet_migrations_daily AS (
    ...
    FROM public.module_ct_cabinet_migrations
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_cabinet_migrations')
        AND COALESCE(migration_date, created_at::date) >= CURRENT_DATE - INTERVAL '90 days'
    ...
    FROM public.module_ct_cabinet_migrations
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_cabinet_migrations')
        AND COALESCE(created_at, updated_at)::date >= CURRENT_DATE - INTERVAL '90 days'
...
source_module_ct_scout_drivers_daily AS (
    SELECT 
        'module_ct_scout_drivers' AS source_name,
        'business' AS metric_type,
        COALESCE(date, registration_date, created_at::date) AS metric_date,
        COUNT(*) AS rows_count
    FROM public.module_ct_scout_drivers
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_scout_drivers')
        AND COALESCE(date, registration_date, created_at::date) >= CURRENT_DATE - INTERVAL '90 days'
    GROUP BY COALESCE(date, registration_date, created_at::date)
    UNION ALL
    SELECT 
        'module_ct_scout_drivers' AS source_name,
        'ingestion' AS metric_type,
...
source_module_ct_cabinet_payments_daily AS (
    ...
    FROM public.module_ct_cabinet_payments
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_cabinet_payments')
        AND COALESCE(snapshot_at, created_at, updated_at)::date >= CURRENT_DATE - INTERVAL '90 days'
...
source_module_ct_scouts_list_daily AS (
    ...
    FROM public.module_ct_scouts_list
    WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_scouts_list')
        AND COALESCE(created_at::date, updated_at::date) >= CURRENT_DATE - INTERVAL '90 days'
...
UNION ALL
SELECT * FROM source_raw_module_ct_cabinet_payments_daily WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'raw' AND table_name = 'module_ct_cabinet_payments')
UNION ALL
SELECT * FROM source_module_ct_cabinet_leads_daily
UNION ALL
SELECT * FROM source_module_ct_scouting_daily_daily
UNION ALL
SELECT * FROM source_module_ct_cabinet_migrations_daily WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_cabinet_migrations')
UNION ALL
SELECT * FROM source_module_ct_scout_drivers_daily WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_scout_drivers')
UNION ALL
SELECT * FROM source_module_ct_cabinet_payments_daily WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_cabinet_payments')
UNION ALL
SELECT * FROM source_drivers_daily
UNION ALL
SELECT * FROM source_module_ct_scouts_list_daily WHERE EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'module_ct_scouts_list');
