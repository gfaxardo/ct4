# Script para crear la vista ops.v_payments_driver_matrix_cabinet
...
$sqlFile = Join-Path $PSScriptRoot "..\sql\ops\v_payments_driver_matrix_cabinet.sql"
...
Write-Host "Creando vista ops.v_payments_driver_matrix_cabinet..." -ForegroundColor Yellow
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        ...
        $verifyQuery = "SELECT COUNT(*) FROM ops.v_payments_driver_matrix_cabinet LIMIT 1;"
