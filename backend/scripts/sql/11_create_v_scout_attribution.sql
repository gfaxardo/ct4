...
'Vista canónica de atribución scout: 1 fila por person_key usando la fuente de mayor prioridad. Prioridad: 1=lead_ledger (source-of-truth), 2=lead_events, 3=migrations, 4=scouting_daily. Desempate por attribution_date DESC, created_at DESC.';
...
-- ============================================================================
-- VALIDACIÓN: Verificar que no hay duplicados por person_key
-- ============================================================================

SELECT 
    'VALIDACIÓN: Duplicados por person_key' AS check_type,
    COUNT(*) AS total_rows,
