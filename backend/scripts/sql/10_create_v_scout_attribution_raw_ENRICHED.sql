-- ============================================================================
-- VISTA: ops.v_scout_attribution_raw (ENRIQUECIDA)
-- ============================================================================
...
-- - Agregada PRIORITY 5: public.module_ct_cabinet_payments.scout_id
-- ============================================================================
...
-- PRIORITY 5: public.module_ct_cabinet_payments.scout_id (NUEVO)
SELECT DISTINCT
    cp.person_key,
