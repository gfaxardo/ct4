...
'Vista RAW de atribución scout desde todas las fuentes. UNION ALL estandarizando campos: person_key, driver_id, driver_license, driver_phone, scout_id, origin_tag, source_table, source_pk, attribution_date, priority. Prioridad: 1=lead_ledger, 2=lead_events, 3=migrations, 4=scouting_daily.';

COMMENT ON COLUMN ops.v_scout_attribution_raw.priority IS 
'Prioridad de la fuente: 1=lead_ledger (source-of-truth), 2=lead_events, 3=module_ct_migrations, 4=scouting_daily';
